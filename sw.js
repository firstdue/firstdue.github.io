...
const CACHE = 'local-shell-v45';  // v20h: v20g plus the owner's ride fixes - the pad takes the nearest legal turn, a divided crossing is one junction, freeway exits take the pad, no rolling into dead-end scraps.
